	...
	window.addEventListener("load", function()
	{
		...
		else 
		{
			...
			setTimeout(function () {
				...
				//alert("You are currently using an ad blocker. Ad blockers will cause the site not to work properly. Please whitelist this domain and reload the page. Don't worry, there are no ads here! :)");
			}, 15000);
